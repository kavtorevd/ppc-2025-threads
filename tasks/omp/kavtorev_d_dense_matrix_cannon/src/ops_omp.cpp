...
std::vector<double> kavtorev_d_dense_matrix_cannon_omp::CannonMatrixMultiplication(const std::vector<double>& a,
...
std::vector<double> kavtorev_d_dense_matrix_cannon_omp::MultiplyMatrix(const std::vector<double>& a,
...
bool kavtorev_d_dense_matrix_cannon_omp::TestTaskSequential::PreProcessingImpl() {
...
bool kavtorev_d_dense_matrix_cannon_omp::TestTaskSequential::ValidationImpl() {
...
bool kavtorev_d_dense_matrix_cannon_omp::TestTaskSequential::RunImpl() {
  res_ = CannonMatrixMultiplication(A_, B_, n_, m_);
  return true;
}

bool kavtorev_d_dense_matrix_cannon_omp::TestTaskSequential::PostProcessingImpl() {
